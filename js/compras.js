...
const cardapioDiario = {
    ...
    4: ['Pernil Assado', 'Coxa e Sobrecoxa ao Molho com Batata'],
    5: ['Feijoada', 'Filé de Frango KFC', 'Bisteca a Milanesa'],
    6: ['Feijoada', 'Filé de Frango a Parmegiana', 'Filé de Frango KFC','Bisteca a Milanesa'],
};
